  ...
  theme: {
    extend: {
      colors: {
        ...
        gold: "#39D2C0",
        "gold-dark": "#2bb3a3",
        // Flutter landing accent palette
        "brand-navy": "#160869",
        tertiary: "#EE8B60",
        coral: "#FF5963",
        sun: "#F9CF58",
      ...
      fontFamily: {
        // Headings match the Care Royal Flutter landing (Roboto display); body = Inter.
        serif: ["'Roboto'", "'Inter'", "system-ui", "-apple-system", "sans-serif"],
